...
To download course resources locate them on our course GitHub, please clone the repo and perform the following steps from [cu-hsp-learning](https://github.com/jkorn81/cu-hsp-learning):

---

(2) Install [R <=3.5](https://cran.r-project.org/bin/) and [Rstudio](https://www.rstudio.com/products/rstudio/download/). 
