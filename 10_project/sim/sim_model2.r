...
model <- readRDS("./final_model2.rds") # Load Model State ----
for(i in 1:1000){ # Loop Through Data to simulate Instances...
  ...
  write.csv(original_window,"data/original_window2.csv", row.names = FALSE) # save rolling slice of data 
  ...
  str(df_total_window)
  write.csv(df_total_window,"data/df_total_pred2.csv", row.names = FALSE)
