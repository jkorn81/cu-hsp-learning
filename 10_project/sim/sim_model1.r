...
model <- readRDS("./final_model1.rds") # Load Model State ----
for(i in 1:1000){ # Loop Through Data to simulate Instances...
  ...
  write.csv(original_window,"data/original_window1.csv", row.names = FALSE) # save rolling slice of data 
  ...
  str(df_total_window)
  write.csv(df_total_window,"data/df_total_pred1.csv", row.names = FALSE)
