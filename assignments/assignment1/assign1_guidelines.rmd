...
**Step 1:** Open the rmarkdown file labeled `assign1.rmd` @ [assignment1](https://github.com/jkorn81/cu-hsp-learning/tree/main/assignments/assignment1)
...
**Step 4:** When you have addressed all the questions providing a response in each of the empty code chunks you can knit the file by clicking on the `Knit` button. 
